...
public class AccountManager {
	...
	public static Account getAccount(String name) throws AccountNotFoundException {
		...
		ArrayList<Account> accountss = new ArrayList<>();
		accountss.addAll(assets);
		accountss.addAll(liabilities);
		for(Account some: accountss){
			if(some.getName().equals(name)){
				accountToFind=some;
			}
		}
